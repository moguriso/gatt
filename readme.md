...
## Usage
Please see [godoc.org](http://godoc.org/github.com/moguriso/gatt) for documentation.
...
Please check [#32](https://github.com/moguriso/gatt/issues/32) for the status of this issue.
